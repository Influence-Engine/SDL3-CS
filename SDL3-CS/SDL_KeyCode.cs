...
namespace SDL3
{
    public static partial class SDL
    {
        ...
        public enum KeyCode
        {
            ...
            Wake = ScanCode.Wake | ScanCodeMask,
            ChannelIncrement = ScanCode.ChannelIncrement | ScanCodeMask,
            ChannelDecrement = ScanCode.ChannelDecrement | ScanCodeMask,

            MediaNextTrack = ScanCode.MediaNextTrack | ScanCodeMask,
            MediaPreviousTrack = ScanCode.MediaPreviousTrack | ScanCodeMask,
            MediaStop = ScanCode.MediaStop | ScanCodeMask,
            MediaPlay = ScanCode.MediaPlay | ScanCodeMask,
            MediaPause = ScanCode.MediaPause | ScanCodeMask,
            MediaRecord = ScanCode.MediaRecord | ScanCodeMask,
            MediaRewind = ScanCode.MediaRewind | ScanCodeMask,
            MediaFastForward = ScanCode.MediaFastForward | ScanCodeMask,
            MediaEject = ScanCode.MediaEject | ScanCodeMask,
            MediaPlayPause = ScanCode.MediaPlayPause | ScanCodeMask,
            MediaSelect = ScanCode.MediaSelect | ScanCodeMask,

            ACNew = ScanCode.ACNew | ScanCodeMask,
            ACOpen = ScanCode.ACOpen | ScanCodeMask,
            ACClose = ScanCode.ACClose | ScanCodeMask,
            ACExit = ScanCode.ACExit | ScanCodeMask,
            ACSave = ScanCode.ACSave | ScanCodeMask,
            ACPrint = ScanCode.ACPrint | ScanCodeMask,
            ACProperties = ScanCode.ACProperties | ScanCodeMask,
