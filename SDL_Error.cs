...
namespace SDL3
{
    public static partial class SDL
    {
        ...
        static extern unsafe bool Internal_SetError(byte* fmtAndArglist);

        /// <summary>Set the SDL error message for the current thread.</summary>
        /// <param name="fmtAndArglist">The error message</param>
        /// <returns>False</returns>
        public static unsafe bool SetError(string fmtAndArglist)
        {
            ...
            return Internal_SetError(Utility.UTF8Encode(fmtAndArglist, utf8FmtAndArgList, utf8FmtAndArlistBufferSize));
        }
